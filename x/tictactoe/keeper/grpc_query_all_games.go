...
func (k Keeper) AllGames(goCtx context.Context, req *types.QueryAllGamesRequest) (*types.QueryAllGamesResponse, error) {
	if req == nil {
	...
	return &types.QueryAllGamesResponse{Games: games, Pagination: pageRes}, nil
}
