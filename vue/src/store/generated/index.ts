...
import PaymogTictactoePaymogTictactoeTictactoe from './paymog/tictactoe/paymog.tictactoe.tictactoe'
...
export default { 
  ...
  PaymogTictactoePaymogTictactoeTictactoe: load(PaymogTictactoePaymogTictactoeTictactoe, 'paymog.tictactoe.tictactoe'),
