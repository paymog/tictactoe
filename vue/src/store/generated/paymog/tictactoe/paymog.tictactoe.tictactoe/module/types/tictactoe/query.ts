...
const baseQueryOpenGamesRequest: object = {};
...
export const QueryOpenGamesRequest = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryOpenGamesRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseQueryOpenGamesRequest } as QueryOpenGamesRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryOpenGamesRequest>
  ): QueryOpenGamesRequest {
    const message = { ...baseQueryOpenGamesRequest } as QueryOpenGamesRequest;
    if (object.pagination !== undefined && object.pagination !== null) {
...
const baseQueryOpenGamesResponse: object = {};
...
export const QueryOpenGamesResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryOpenGamesResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseQueryOpenGamesResponse } as QueryOpenGamesResponse;
    message.games = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<QueryOpenGamesResponse>
  ): QueryOpenGamesResponse {
    const message = { ...baseQueryOpenGamesResponse } as QueryOpenGamesResponse;
    message.games = [];
    if (object.games !== undefined && object.games !== null) {
      for (const e of object.games) {
...
export interface Query {
  ...
  AllGames(request: QueryAllGamesRequest): Promise<QueryAllGamesResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "paymog.tictactoe.tictactoe.Query",
      "Params",
      data
    );
  ...
  OpenGames(request: QueryOpenGamesRequest): Promise<QueryOpenGamesResponse> {
    ...
    return promise.then((data) =>
      QueryOpenGamesResponse.decode(new Reader(data))
    );
  }
