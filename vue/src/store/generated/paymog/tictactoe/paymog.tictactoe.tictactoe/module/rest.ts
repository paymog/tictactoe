...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/paymog/tictactoe/tictactoe/open_games
   */
  queryOpenGames = (
    query?: {
    ...
    this.request<TictactoeQueryOpenGamesResponse, RpcStatus>({
      path: `/paymog/tictactoe/tictactoe/open_games`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/paymog/tictactoe/tictactoe/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<TictactoeQueryParamsResponse, RpcStatus>({
      path: `/paymog/tictactoe/tictactoe/params`,
      method: "GET",
      format: "json",
      ...params,
    });
